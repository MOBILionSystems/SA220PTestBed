////////////////////////////////////////////////////////////////////////////////////////////////////
// Copyright (C) Acqiris SA 2019-2021
//--------------------------------------------------------------------------------------------------
...
namespace LibTool
{
    ...
    namespace ZeroSuppress
    {
        ...
        struct ProcessingParameters
        {
            ...
            ProcessingParameters(int32_t storageSamples, int32_t processingSamples, double tsPeriod, int32_t preGate, int32_t postGate)
        ...
        public:
            //! Constructs start marker object from a raw 64-bit marker.
            ...
            GateStartMarker(int32_t element0, int32_t element1);
        ...
        {
        public:
            GateMarker(GateStartMarker const& startMarker, GateStopMarker const& stopMarker);
            ...
            //! Extract gate position from a raw 64-bit marker (start or stop).
        ...
        public:
            ...
            std::vector<RecordDescriptor> Take(int count);
        ...
        , m_stopMarker(stopMarker)
    {
        ...
        {
            // this might be caused when the block index counter wraps around. In such case, "stop.m_blockIndex" must be incremented by 2**32 (recordIndex counter is 32-bit)
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //
    // RecordDescriptorQueue member definitions
    //
    ...
    inline std::vector<ZeroSuppress::RecordDescriptor> ZeroSuppress::MarkerStreamDecoder::Take(int count)
    {
        if (count <= 0)
    ...
    {
        if (stream.Size() == 0)
            throw std::runtime_error("Cannot decode markers from empty stream");
